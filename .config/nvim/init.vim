...
let $FZF_DEFAULT_COMMAND='rg --files --hidden --max-filesize 50K --smart-case'
" let $FZF_DEFAULT_COMMAND='rg -asdf'

command! -bang -nargs=* PRg
  \ call fzf#vim#grep("rg --max-filesize 50K --column --line-number --no-heading --color=always --smart-case ".shellescape(<q-args>), 1, {'dir': system('git -C '.expand('%:p:h').' rev-parse --show-toplevel 2> /dev/null')[:-2]}, <bang>0)
